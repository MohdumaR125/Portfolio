...
const Projects = () => {
  return (
    <div className={Styles.projectparent}>
      ...
      <div>
        ...
        <div>
          ...
          <div className={Styles.para}>
            JioMart is an online grocery store that provides 50,000+ grocery
            products at discounted rates at your doorstep through an express
            delivery system. It follows an on-demand model.
          </div>
          ...
          <div className={Styles.prosvg}>
            <a
              href="https://github.com/Sibghataziz/JioMartClone"
              target="_blank"
      ...
      <div>
      <div className={Styles.myntraimg}>
          <div className={Styles.layer}></div>
        </div>
        <div>
          <h1>Myntra Clone</h1>
          ...
          <div className={Styles.prosvg}>
            ...
            <a
              href="https://profound-frangipane-533d7c.netlify.app/"
              target="_blank"
              rel="nofollow noopener noreferrer"
              aria-label="External Link"
            >
      ...
      <div>
      <div className={Styles.swiggyimg}>
          <div className={Styles.layer}></div>
        </div>
          <div>
            <h1>Swiggy Clone</h1>
            <div className={Styles.para}>
              Swiggy is the leading food ordering and delivery platform in
              India. This innovative technology has enabled a host of benefits
              that includes lightning fast deliveries, live order and no
              restrictions on order amount, all while having the pleasure of
            ...
            <div className={Styles.prosvg}>
              <a
                href="https://github.com/ramgopalshukla/swiggyclone"
                target="_blank"
                rel="nofollow noopener noreferrer"
                aria-label="GitHub Link"
              >
              ...
              <a
                href="https://swiggy-clone-akash.netlify.app/"
                target="_blank"
                rel="nofollow noopener noreferrer"
                aria-label="External Link"
              >
